...
func NewItemHooksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemHooksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/orgs/{org}/hooks{?per_page*,page*}";
...
func (m *ItemHooksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemHooksRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.OrgHookable, error) {
    ...
    res, err := m.requestAdapter.SendCollection(ctx, requestInfo, ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreateOrgHookFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.OrgHookable, len(res))
    for i, v := range res {
        val[i] = v.(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.OrgHookable)
    }
    return val, nil
}
...
func (m *ItemHooksRequestBuilder) Post(ctx context.Context, body ItemHooksPostRequestBodyable, requestConfiguration *ItemHooksRequestBuilderPostRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.OrgHookable, error) {
