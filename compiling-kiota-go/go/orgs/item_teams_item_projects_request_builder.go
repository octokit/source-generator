...
func NewItemTeamsItemProjectsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemTeamsItemProjectsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/orgs/{org}/teams/{team_slug}/projects{?per_page*,page*}";
...
func (m *ItemTeamsItemProjectsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemTeamsItemProjectsRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.TeamProjectable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.requestAdapter.SendCollection(ctx, requestInfo, ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreateTeamProjectFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
