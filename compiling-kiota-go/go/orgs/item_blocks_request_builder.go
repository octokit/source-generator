...
func NewItemBlocksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemBlocksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/orgs/{org}/blocks{?per_page*,page*}";
...
func (m *ItemBlocksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemBlocksRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.SimpleUserable, error) {
