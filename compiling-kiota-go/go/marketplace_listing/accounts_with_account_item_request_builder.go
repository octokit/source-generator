...
func NewAccountsWithAccount_ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*AccountsWithAccount_ItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/marketplace_listing/accounts/{account_id}";
...
func (m *AccountsWithAccount_ItemRequestBuilder) Get(ctx context.Context, requestConfiguration *AccountsWithAccount_ItemRequestBuilderGetRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.MarketplacePurchaseable, error) {
