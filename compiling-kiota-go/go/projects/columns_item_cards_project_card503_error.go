...
// ColumnsItemCardsProjectCard503Error 
type ColumnsItemCardsProjectCard503Error struct {
    ...
    // The errors property
    errors []ColumnsItemCardsProjectCard503Error_errorsable
...
func NewColumnsItemCardsProjectCard503Error()(*ColumnsItemCardsProjectCard503Error) {
    m := &ColumnsItemCardsProjectCard503Error{
        ApiError: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewApiError(),
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateColumnsItemCardsProjectCard503ErrorFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateColumnsItemCardsProjectCard503ErrorFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewColumnsItemCardsProjectCard503Error(), nil
}
...
func (m *ColumnsItemCardsProjectCard503Error) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["errors"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateColumnsItemCardsProjectCard503Error_errorsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ColumnsItemCardsProjectCard503Error_errorsable, len(val))
            for i, v := range val {
