...
// NewColumnsCardsRequestBuilderInternal instantiates a new CardsRequestBuilder and sets the default values.
func NewColumnsCardsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ColumnsCardsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/projects/columns/cards";
...
// NewColumnsCardsRequestBuilder instantiates a new CardsRequestBuilder and sets the default values.
