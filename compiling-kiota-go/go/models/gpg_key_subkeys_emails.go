...
func (m *GpgKey_subkeys_emails) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GpgKey_subkeys_emails) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetEmail sets the email property value. The email property
func (m *GpgKey_subkeys_emails) SetEmail(value *string)() {
    m.email = value
}
