...
func (m *PagesHealthCheck_alt_domain) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagesHealthCheck_alt_domain) SetIsCnameToGithubUserDomain(value *bool)() {
...
func (m *PagesHealthCheck_alt_domain) SetIsNonGithubPagesIpPresent(value *bool)() {
...
func (m *PagesHealthCheck_alt_domain) SetIsOldIpAddress(value *bool)() {
    m.is_old_ip_address = value
}
// SetIsPagesDomain sets the is_pages_domain property value. The is_pages_domain property
func (m *PagesHealthCheck_alt_domain) SetIsPagesDomain(value *bool)() {
