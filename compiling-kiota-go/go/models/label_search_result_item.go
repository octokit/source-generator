...
type LabelSearchResultItem struct {
    ...
    text_matches []LabelSearchResultItem_text_matchesable
    // The url property
    url *string
}
...
// GetDefault gets the default property value. The default property
func (m *LabelSearchResultItem) GetDefault()(*bool) {
...
func (m *LabelSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateLabelSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]LabelSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(LabelSearchResultItem_text_matchesable)
            }
...
func (m *LabelSearchResultItem) GetScore()(*int64) {
    return m.score
}
// GetTextMatches gets the text_matches property value. The text_matches property
func (m *LabelSearchResultItem) GetTextMatches()([]LabelSearchResultItem_text_matchesable) {
...
// SetDefault sets the default property value. The default property
func (m *LabelSearchResultItem) SetDefault(value *bool)() {
...
func (m *LabelSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
// SetTextMatches sets the text_matches property value. The text_matches property
func (m *LabelSearchResultItem) SetTextMatches(value []LabelSearchResultItem_text_matchesable)() {
