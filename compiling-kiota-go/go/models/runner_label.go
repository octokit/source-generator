...
func (m *RunnerLabel) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetType(val.(*RunnerLabel_type))
        }
        return nil
    }
    return res
...
// GetType gets the type property value. The type of label. Read-only labels are applied automatically when the runner is configured.
func (m *RunnerLabel) GetType()(*RunnerLabel_type) {
...
// SetType sets the type property value. The type of label. Read-only labels are applied automatically when the runner is configured.
func (m *RunnerLabel) SetType(value *RunnerLabel_type)() {
    m.typeEscaped = value
}
