...
type UserSearchResultItem struct {
    ...
    text_matches []UserSearchResultItem_text_matchesable
    // The type property
    typeEscaped *string
...
func (m *UserSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateUserSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]UserSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(UserSearchResultItem_text_matchesable)
            }
...
func (m *UserSearchResultItem) GetScore()(*int64) {
    return m.score
}
...
func (m *UserSearchResultItem) GetTextMatches()([]UserSearchResultItem_text_matchesable) {
    return m.text_matches
}
// GetType gets the type property value. The type property
func (m *UserSearchResultItem) GetType()(*string) {
...
func (m *UserSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
...
func (m *UserSearchResultItem) SetTextMatches(value []UserSearchResultItem_text_matchesable)() {
    m.text_matches = value
}
// SetType sets the type property value. The type property
func (m *UserSearchResultItem) SetType(value *string)() {
    m.typeEscaped = value
}
