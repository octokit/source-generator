...
func (m *EnvironmentApprovals_environments) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *EnvironmentApprovals_environments) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCreatedAt sets the created_at property value. The time that the environment was created, in ISO 8601 format.
func (m *EnvironmentApprovals_environments) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.created_at = value
}
// SetHtmlUrl sets the html_url property value. The html_url property
func (m *EnvironmentApprovals_environments) SetHtmlUrl(value *string)() {
    m.html_url = value
}
// SetId sets the id property value. The id of the environment.
func (m *EnvironmentApprovals_environments) SetId(value *int32)() {
    m.id = value
}
// SetName sets the name property value. The name of the environment.
func (m *EnvironmentApprovals_environments) SetName(value *string)() {
    m.name = value
}
// SetNodeId sets the node_id property value. The node_id property
func (m *EnvironmentApprovals_environments) SetNodeId(value *string)() {
    m.node_id = value
}
// SetUpdatedAt sets the updated_at property value. The time that the environment was last updated, in ISO 8601 format.
func (m *EnvironmentApprovals_environments) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updated_at = value
}
