...
// NewCodeScanningAlertItems instantiates a new CodeScanningAlertItems and sets the default values.
func NewCodeScanningAlertItems()(*CodeScanningAlertItems) {
    m := &CodeScanningAlertItems{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateCodeScanningAlertItemsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateCodeScanningAlertItemsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCodeScanningAlertItems(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *CodeScanningAlertItems) GetAdditionalData()(map[string]any) {
...
func (m *CodeScanningAlertItems) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.created_at
}
...
func (m *CodeScanningAlertItems) GetDismissedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.dismissed_at
}
// GetDismissedBy gets the dismissed_by property value. A GitHub user.
func (m *CodeScanningAlertItems) GetDismissedBy()(NullableSimpleUserable) {
...
func (m *CodeScanningAlertItems) GetDismissedComment()(*string) {
...
func (m *CodeScanningAlertItems) GetDismissedReason()(*CodeScanningAlertDismissedReason) {
    return m.dismissed_reason
}
// GetFieldDeserializers the deserialization information for the current model
func (m *CodeScanningAlertItems) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CodeScanningAlertItems) GetFixedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.fixed_at
}
// GetHtmlUrl gets the html_url property value. The GitHub URL of the alert resource.
func (m *CodeScanningAlertItems) GetHtmlUrl()(*string) {
    return m.html_url
}
// GetInstancesUrl gets the instances_url property value. The REST API URL for fetching the list of instances for an alert.
func (m *CodeScanningAlertItems) GetInstancesUrl()(*string) {
...
func (m *CodeScanningAlertItems) GetMostRecentInstance()(CodeScanningAlertInstanceable) {
    return m.most_recent_instance
}
// GetNumber gets the number property value. The security alert number.
func (m *CodeScanningAlertItems) GetNumber()(*int32) {
    return m.number
}
// GetRule gets the rule property value. The rule property
func (m *CodeScanningAlertItems) GetRule()(CodeScanningAlertRuleSummaryable) {
    return m.rule
}
// GetState gets the state property value. State of a code scanning alert.
func (m *CodeScanningAlertItems) GetState()(*CodeScanningAlertState) {
    return m.state
}
// GetTool gets the tool property value. The tool property
func (m *CodeScanningAlertItems) GetTool()(CodeScanningAnalysisToolable) {
    return m.tool
}
...
func (m *CodeScanningAlertItems) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updated_at
}
// GetUrl gets the url property value. The REST API URL of the alert resource.
func (m *CodeScanningAlertItems) GetUrl()(*string) {
    return m.url
}
// Serialize serializes information the current object
func (m *CodeScanningAlertItems) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CodeScanningAlertItems) SetAdditionalData(value map[string]any)() {
...
func (m *CodeScanningAlertItems) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.created_at = value
}
...
func (m *CodeScanningAlertItems) SetDismissedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.dismissed_at = value
}
// SetDismissedBy sets the dismissed_by property value. A GitHub user.
func (m *CodeScanningAlertItems) SetDismissedBy(value NullableSimpleUserable)() {
...
func (m *CodeScanningAlertItems) SetDismissedComment(value *string)() {
...
func (m *CodeScanningAlertItems) SetDismissedReason(value *CodeScanningAlertDismissedReason)() {
...
func (m *CodeScanningAlertItems) SetFixedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.fixed_at = value
}
// SetHtmlUrl sets the html_url property value. The GitHub URL of the alert resource.
func (m *CodeScanningAlertItems) SetHtmlUrl(value *string)() {
    m.html_url = value
}
// SetInstancesUrl sets the instances_url property value. The REST API URL for fetching the list of instances for an alert.
func (m *CodeScanningAlertItems) SetInstancesUrl(value *string)() {
...
func (m *CodeScanningAlertItems) SetMostRecentInstance(value CodeScanningAlertInstanceable)() {
    m.most_recent_instance = value
}
// SetNumber sets the number property value. The security alert number.
func (m *CodeScanningAlertItems) SetNumber(value *int32)() {
    m.number = value
}
// SetRule sets the rule property value. The rule property
func (m *CodeScanningAlertItems) SetRule(value CodeScanningAlertRuleSummaryable)() {
    m.rule = value
}
// SetState sets the state property value. State of a code scanning alert.
func (m *CodeScanningAlertItems) SetState(value *CodeScanningAlertState)() {
    m.state = value
}
// SetTool sets the tool property value. The tool property
func (m *CodeScanningAlertItems) SetTool(value CodeScanningAnalysisToolable)() {
    m.tool = value
}
...
func (m *CodeScanningAlertItems) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updated_at = value
}
// SetUrl sets the url property value. The REST API URL of the alert resource.
func (m *CodeScanningAlertItems) SetUrl(value *string)() {
    m.url = value
}
