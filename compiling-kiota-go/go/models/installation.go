...
type Installation struct {
    ...
    account Installation_Installationsable
...
// Installation_Installations composed type wrapper for classes simpleUser, enterprise
type Installation_Installations struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
...
// NewInstallation_Installations instantiates a new installations and sets the default values.
func NewInstallation_Installations()(*Installation_Installations) {
    m := &Installation_Installations{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateInstallation_InstallationsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateInstallation_InstallationsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewInstallation_Installations()
    if parseNode != nil {
...
func (m *Installation_Installations) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetEnterprise gets the enterprise property value. Composed type representation for type enterprise
func (m *Installation_Installations) GetEnterprise()(Enterpriseable) {
    return m.enterprise
}
// GetFieldDeserializers the deserialization information for the current model
func (m *Installation_Installations) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetSimpleUser gets the simpleUser property value. Composed type representation for type simpleUser
func (m *Installation_Installations) GetSimpleUser()(SimpleUserable) {
    return m.simpleUser
}
// Serialize serializes information the current object
func (m *Installation_Installations) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *Installation_Installations) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetEnterprise sets the enterprise property value. Composed type representation for type enterprise
func (m *Installation_Installations) SetEnterprise(value Enterpriseable)() {
    m.enterprise = value
}
// SetSimpleUser sets the simpleUser property value. Composed type representation for type simpleUser
func (m *Installation_Installations) SetSimpleUser(value SimpleUserable)() {
    m.simpleUser = value
}
// Installation_Installationsable 
type Installation_Installationsable interface {
...
func (m *Installation) GetAccount()(Installation_Installationsable) {
    return m.account
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
...
func (m *Installation) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["account"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateInstallation_InstallationsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAccount(val.(Installation_Installationsable))
        }
        return nil
    }
...
func (m *Installation) SetAccount(value Installation_Installationsable)() {
    m.account = value
}
// SetAdditionalData sets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
