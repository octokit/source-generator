...
type Repository_template_repository struct {
    ...
    merge_commit_message *Repository_template_repository_merge_commit_message
    // The default value for a merge commit title.- `PR_TITLE` - default to the pull request's title.- `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
    merge_commit_title *Repository_template_repository_merge_commit_title
    ...
    // The owner property
    owner Repository_template_repository_ownerable
    // The permissions property
    permissions Repository_template_repository_permissionsable
    ...
    squash_merge_commit_message *Repository_template_repository_squash_merge_commit_message
    // The default value for a squash merge commit title:- `PR_TITLE` - default to the pull request's title.- `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
    squash_merge_commit_title *Repository_template_repository_squash_merge_commit_title
...
// NewRepository_template_repository instantiates a new repository_template_repository and sets the default values.
func NewRepository_template_repository()(*Repository_template_repository) {
    m := &Repository_template_repository{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateRepository_template_repositoryFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateRepository_template_repositoryFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewRepository_template_repository(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *Repository_template_repository) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAllowAutoMerge gets the allow_auto_merge property value. The allow_auto_merge property
func (m *Repository_template_repository) GetAllowAutoMerge()(*bool) {
    return m.allow_auto_merge
}
// GetAllowMergeCommit gets the allow_merge_commit property value. The allow_merge_commit property
func (m *Repository_template_repository) GetAllowMergeCommit()(*bool) {
...
func (m *Repository_template_repository) GetAllowRebaseMerge()(*bool) {
...
func (m *Repository_template_repository) GetAllowSquashMerge()(*bool) {
...
func (m *Repository_template_repository) GetDeleteBranchOnMerge()(*bool) {
    return m.delete_branch_on_merge
}
// GetDeploymentsUrl gets the deployments_url property value. The deployments_url property
func (m *Repository_template_repository) GetDeploymentsUrl()(*string) {
    return m.deployments_url
}
// GetDescription gets the description property value. The description property
func (m *Repository_template_repository) GetDescription()(*string) {
    return m.description
}
// GetDisabled gets the disabled property value. The disabled property
func (m *Repository_template_repository) GetDisabled()(*bool) {
    return m.disabled
}
// GetDownloadsUrl gets the downloads_url property value. The downloads_url property
func (m *Repository_template_repository) GetDownloadsUrl()(*string) {
    return m.downloads_url
}
// GetEventsUrl gets the events_url property value. The events_url property
func (m *Repository_template_repository) GetEventsUrl()(*string) {
    return m.events_url
}
// GetFieldDeserializers the deserialization information for the current model
func (m *Repository_template_repository) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["merge_commit_message"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRepository_template_repository_merge_commit_message)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMergeCommitMessage(val.(*Repository_template_repository_merge_commit_message))
        }
        return nil
    }
    res["merge_commit_title"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRepository_template_repository_merge_commit_title)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMergeCommitTitle(val.(*Repository_template_repository_merge_commit_title))
        }
        return nil
    }
    ...
    res["owner"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateRepository_template_repository_ownerFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetOwner(val.(Repository_template_repository_ownerable))
        }
        return nil
    }
    res["permissions"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateRepository_template_repository_permissionsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPermissions(val.(Repository_template_repository_permissionsable))
        }
        return nil
    }
    ...
    res["squash_merge_commit_message"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRepository_template_repository_squash_merge_commit_message)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSquashMergeCommitMessage(val.(*Repository_template_repository_squash_merge_commit_message))
        }
        return nil
    }
    res["squash_merge_commit_title"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseRepository_template_repository_squash_merge_commit_title)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSquashMergeCommitTitle(val.(*Repository_template_repository_squash_merge_commit_title))
        }
        return nil
    }
...
func (m *Repository_template_repository) GetMergeCommitMessage()(*Repository_template_repository_merge_commit_message) {
...
func (m *Repository_template_repository) GetMergeCommitTitle()(*Repository_template_repository_merge_commit_title) {
    return m.merge_commit_title
}
// GetMergesUrl gets the merges_url property value. The merges_url property
func (m *Repository_template_repository) GetMergesUrl()(*string) {
    return m.merges_url
}
// GetMilestonesUrl gets the milestones_url property value. The milestones_url property
func (m *Repository_template_repository) GetMilestonesUrl()(*string) {
    return m.milestones_url
}
// GetMirrorUrl gets the mirror_url property value. The mirror_url property
func (m *Repository_template_repository) GetMirrorUrl()(*string) {
    return m.mirror_url
}
// GetName gets the name property value. The name property
func (m *Repository_template_repository) GetName()(*string) {
    return m.name
}
// GetNetworkCount gets the network_count property value. The network_count property
func (m *Repository_template_repository) GetNetworkCount()(*int32) {
    return m.network_count
}
// GetNodeId gets the node_id property value. The node_id property
func (m *Repository_template_repository) GetNodeId()(*string) {
    return m.node_id
}
// GetNotificationsUrl gets the notifications_url property value. The notifications_url property
func (m *Repository_template_repository) GetNotificationsUrl()(*string) {
...
func (m *Repository_template_repository) GetOwner()(Repository_template_repository_ownerable) {
    return m.owner
}
// GetPermissions gets the permissions property value. The permissions property
func (m *Repository_template_repository) GetPermissions()(Repository_template_repository_permissionsable) {
    return m.permissions
}
// GetPrivate gets the private property value. The private property
func (m *Repository_template_repository) GetPrivate()(*bool) {
    return m.private
}
// GetPullsUrl gets the pulls_url property value. The pulls_url property
func (m *Repository_template_repository) GetPullsUrl()(*string) {
    return m.pulls_url
}
// GetPushedAt gets the pushed_at property value. The pushed_at property
func (m *Repository_template_repository) GetPushedAt()(*string) {
    return m.pushed_at
}
// GetReleasesUrl gets the releases_url property value. The releases_url property
func (m *Repository_template_repository) GetReleasesUrl()(*string) {
    return m.releases_url
}
// GetSize gets the size property value. The size property
func (m *Repository_template_repository) GetSize()(*int32) {
    return m.size
}
...
func (m *Repository_template_repository) GetSquashMergeCommitMessage()(*Repository_template_repository_squash_merge_commit_message) {
...
func (m *Repository_template_repository) GetUseSquashPrTitleAsDefault()(*bool) {
    return m.use_squash_pr_title_as_default
}
// GetVisibility gets the visibility property value. The visibility property
func (m *Repository_template_repository) GetVisibility()(*string) {
    return m.visibility
}
// GetWatchersCount gets the watchers_count property value. The watchers_count property
func (m *Repository_template_repository) GetWatchersCount()(*int32) {
    return m.watchers_count
}
// Serialize serializes information the current object
func (m *Repository_template_repository) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *Repository_template_repository) SetMergeCommitMessage(value *Repository_template_repository_merge_commit_message)() {
...
func (m *Repository_template_repository) SetMergeCommitTitle(value *Repository_template_repository_merge_commit_title)() {
    m.merge_commit_title = value
}
// SetMergesUrl sets the merges_url property value. The merges_url property
func (m *Repository_template_repository) SetMergesUrl(value *string)() {
    m.merges_url = value
}
// SetMilestonesUrl sets the milestones_url property value. The milestones_url property
func (m *Repository_template_repository) SetMilestonesUrl(value *string)() {
    m.milestones_url = value
}
// SetMirrorUrl sets the mirror_url property value. The mirror_url property
func (m *Repository_template_repository) SetMirrorUrl(value *string)() {
    m.mirror_url = value
}
// SetName sets the name property value. The name property
func (m *Repository_template_repository) SetName(value *string)() {
    m.name = value
}
// SetNetworkCount sets the network_count property value. The network_count property
func (m *Repository_template_repository) SetNetworkCount(value *int32)() {
    m.network_count = value
}
// SetNodeId sets the node_id property value. The node_id property
func (m *Repository_template_repository) SetNodeId(value *string)() {
    m.node_id = value
}
// SetNotificationsUrl sets the notifications_url property value. The notifications_url property
func (m *Repository_template_repository) SetNotificationsUrl(value *string)() {
    m.notifications_url = value
}
// SetOpenIssuesCount sets the open_issues_count property value. The open_issues_count property
func (m *Repository_template_repository) SetOpenIssuesCount(value *int32)() {
    m.open_issues_count = value
}
// SetOwner sets the owner property value. The owner property
func (m *Repository_template_repository) SetOwner(value Repository_template_repository_ownerable)() {
    m.owner = value
}
// SetPermissions sets the permissions property value. The permissions property
func (m *Repository_template_repository) SetPermissions(value Repository_template_repository_permissionsable)() {
    m.permissions = value
}
// SetPrivate sets the private property value. The private property
func (m *Repository_template_repository) SetPrivate(value *bool)() {
    m.private = value
}
// SetPullsUrl sets the pulls_url property value. The pulls_url property
func (m *Repository_template_repository) SetPullsUrl(value *string)() {
    m.pulls_url = value
}
// SetPushedAt sets the pushed_at property value. The pushed_at property
func (m *Repository_template_repository) SetPushedAt(value *string)() {
    m.pushed_at = value
}
// SetReleasesUrl sets the releases_url property value. The releases_url property
func (m *Repository_template_repository) SetReleasesUrl(value *string)() {
    m.releases_url = value
}
// SetSize sets the size property value. The size property
func (m *Repository_template_repository) SetSize(value *int32)() {
    m.size = value
}
...
func (m *Repository_template_repository) SetSquashMergeCommitMessage(value *Repository_template_repository_squash_merge_commit_message)() {
...
func (m *Repository_template_repository) SetUseSquashPrTitleAsDefault(value *bool)() {
    m.use_squash_pr_title_as_default = value
}
// SetVisibility sets the visibility property value. The visibility property
func (m *Repository_template_repository) SetVisibility(value *string)() {
    m.visibility = value
}
// SetWatchersCount sets the watchers_count property value. The watchers_count property
func (m *Repository_template_repository) SetWatchersCount(value *int32)() {
