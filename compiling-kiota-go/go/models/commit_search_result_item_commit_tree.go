...
func (m *CommitSearchResultItem_commit_tree) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *CommitSearchResultItem_commit_tree) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetSha sets the sha property value. The sha property
func (m *CommitSearchResultItem_commit_tree) SetSha(value *string)() {
    m.sha = value
}
