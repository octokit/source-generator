...
// GetOne gets the +1 property value. The One property
func (m *ReactionRollup) GetOne()(*int32) {
    return m.one
}
...
func (m *ReactionRollup) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteInt32Value("+1", m.GetOne())
        if err != nil {
            return err
        }
    }
...
// SetOne sets the +1 property value. The One property
func (m *ReactionRollup) SetOne(value *int32)() {
    m.one = value
}
