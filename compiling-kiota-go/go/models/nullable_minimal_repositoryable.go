...
type NullableMinimalRepositoryable interface {
    ...
    GetLicense()(NullableMinimalRepository_licenseable)
    GetMergesUrl()(*string)
    ...
    SetLicense(value NullableMinimalRepository_licenseable)()
    ...
    SetPermissions(value NullableMinimalRepository_permissionsable)()
