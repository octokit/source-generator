...
func (m *DependabotAlertWithRepository_dependency) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["package"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetPackage(val.(DependabotAlertPackageable))
        }
        return nil
    }
...
// GetPackage gets the package property value. Details for the vulnerable package.
func (m *DependabotAlertWithRepository_dependency) GetPackage()(DependabotAlertPackageable) {
...
// SetPackage sets the package property value. Details for the vulnerable package.
func (m *DependabotAlertWithRepository_dependency) SetPackage(value DependabotAlertPackageable)() {
