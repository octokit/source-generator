...
// NewRepository_template_repository_owner instantiates a new repository_template_repository_owner and sets the default values.
func NewRepository_template_repository_owner()(*Repository_template_repository_owner) {
    m := &Repository_template_repository_owner{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateRepository_template_repository_ownerFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateRepository_template_repository_ownerFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewRepository_template_repository_owner(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *Repository_template_repository_owner) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAvatarUrl gets the avatar_url property value. The avatar_url property
func (m *Repository_template_repository_owner) GetAvatarUrl()(*string) {
    return m.avatar_url
}
// GetEventsUrl gets the events_url property value. The events_url property
func (m *Repository_template_repository_owner) GetEventsUrl()(*string) {
    return m.events_url
}
// GetFieldDeserializers the deserialization information for the current model
func (m *Repository_template_repository_owner) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *Repository_template_repository_owner) GetFollowersUrl()(*string) {
    return m.followers_url
}
// GetFollowingUrl gets the following_url property value. The following_url property
func (m *Repository_template_repository_owner) GetFollowingUrl()(*string) {
    return m.following_url
}
// GetGistsUrl gets the gists_url property value. The gists_url property
func (m *Repository_template_repository_owner) GetGistsUrl()(*string) {
    return m.gists_url
}
// GetGravatarId gets the gravatar_id property value. The gravatar_id property
func (m *Repository_template_repository_owner) GetGravatarId()(*string) {
    return m.gravatar_id
}
// GetHtmlUrl gets the html_url property value. The html_url property
func (m *Repository_template_repository_owner) GetHtmlUrl()(*string) {
    return m.html_url
}
// GetId gets the id property value. The id property
func (m *Repository_template_repository_owner) GetId()(*int32) {
    return m.id
}
// GetLogin gets the login property value. The login property
func (m *Repository_template_repository_owner) GetLogin()(*string) {
    return m.login
}
// GetNodeId gets the node_id property value. The node_id property
func (m *Repository_template_repository_owner) GetNodeId()(*string) {
    return m.node_id
}
// GetOrganizationsUrl gets the organizations_url property value. The organizations_url property
func (m *Repository_template_repository_owner) GetOrganizationsUrl()(*string) {
...
func (m *Repository_template_repository_owner) GetReceivedEventsUrl()(*string) {
    return m.received_events_url
}
// GetReposUrl gets the repos_url property value. The repos_url property
func (m *Repository_template_repository_owner) GetReposUrl()(*string) {
    return m.repos_url
}
// GetSiteAdmin gets the site_admin property value. The site_admin property
func (m *Repository_template_repository_owner) GetSiteAdmin()(*bool) {
    return m.site_admin
}
// GetStarredUrl gets the starred_url property value. The starred_url property
func (m *Repository_template_repository_owner) GetStarredUrl()(*string) {
    return m.starred_url
}
// GetSubscriptionsUrl gets the subscriptions_url property value. The subscriptions_url property
func (m *Repository_template_repository_owner) GetSubscriptionsUrl()(*string) {
    return m.subscriptions_url
}
// GetType gets the type property value. The type property
func (m *Repository_template_repository_owner) GetType()(*string) {
    return m.typeEscaped
}
// GetUrl gets the url property value. The url property
func (m *Repository_template_repository_owner) GetUrl()(*string) {
    return m.url
}
// Serialize serializes information the current object
func (m *Repository_template_repository_owner) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *Repository_template_repository_owner) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAvatarUrl sets the avatar_url property value. The avatar_url property
func (m *Repository_template_repository_owner) SetAvatarUrl(value *string)() {
    m.avatar_url = value
}
// SetEventsUrl sets the events_url property value. The events_url property
func (m *Repository_template_repository_owner) SetEventsUrl(value *string)() {
    m.events_url = value
}
// SetFollowersUrl sets the followers_url property value. The followers_url property
func (m *Repository_template_repository_owner) SetFollowersUrl(value *string)() {
    m.followers_url = value
}
// SetFollowingUrl sets the following_url property value. The following_url property
func (m *Repository_template_repository_owner) SetFollowingUrl(value *string)() {
    m.following_url = value
}
// SetGistsUrl sets the gists_url property value. The gists_url property
func (m *Repository_template_repository_owner) SetGistsUrl(value *string)() {
    m.gists_url = value
}
// SetGravatarId sets the gravatar_id property value. The gravatar_id property
func (m *Repository_template_repository_owner) SetGravatarId(value *string)() {
    m.gravatar_id = value
}
// SetHtmlUrl sets the html_url property value. The html_url property
func (m *Repository_template_repository_owner) SetHtmlUrl(value *string)() {
    m.html_url = value
}
// SetId sets the id property value. The id property
func (m *Repository_template_repository_owner) SetId(value *int32)() {
    m.id = value
}
// SetLogin sets the login property value. The login property
func (m *Repository_template_repository_owner) SetLogin(value *string)() {
    m.login = value
}
// SetNodeId sets the node_id property value. The node_id property
func (m *Repository_template_repository_owner) SetNodeId(value *string)() {
    m.node_id = value
}
// SetOrganizationsUrl sets the organizations_url property value. The organizations_url property
func (m *Repository_template_repository_owner) SetOrganizationsUrl(value *string)() {
...
func (m *Repository_template_repository_owner) SetReceivedEventsUrl(value *string)() {
    m.received_events_url = value
}
// SetReposUrl sets the repos_url property value. The repos_url property
func (m *Repository_template_repository_owner) SetReposUrl(value *string)() {
    m.repos_url = value
}
// SetSiteAdmin sets the site_admin property value. The site_admin property
func (m *Repository_template_repository_owner) SetSiteAdmin(value *bool)() {
    m.site_admin = value
}
// SetStarredUrl sets the starred_url property value. The starred_url property
func (m *Repository_template_repository_owner) SetStarredUrl(value *string)() {
    m.starred_url = value
}
// SetSubscriptionsUrl sets the subscriptions_url property value. The subscriptions_url property
func (m *Repository_template_repository_owner) SetSubscriptionsUrl(value *string)() {
    m.subscriptions_url = value
}
// SetType sets the type property value. The type property
func (m *Repository_template_repository_owner) SetType(value *string)() {
    m.typeEscaped = value
}
// SetUrl sets the url property value. The url property
func (m *Repository_template_repository_owner) SetUrl(value *string)() {
    m.url = value
}
