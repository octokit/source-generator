...
type RepoSearchResultItem struct {
    ...
    text_matches []RepoSearchResultItem_text_matchesable
    // The topics property
    topics []string
...
func (m *RepoSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateRepoSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]RepoSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(RepoSearchResultItem_text_matchesable)
            }
...
func (m *RepoSearchResultItem) GetScore()(*int64) {
    return m.score
}
...
func (m *RepoSearchResultItem) GetTextMatches()([]RepoSearchResultItem_text_matchesable) {
...
func (m *RepoSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
...
func (m *RepoSearchResultItem) SetTextMatches(value []RepoSearchResultItem_text_matchesable)() {
