...
// NullableCollaboratorable 
type NullableCollaboratorable interface {
    ...
    GetPermissions()(NullableCollaborator_permissionsable)
    ...
    SetPermissions(value NullableCollaborator_permissionsable)()
