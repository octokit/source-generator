...
type IssueSearchResultItem struct {
    ...
    text_matches []IssueSearchResultItem_text_matchesable
...
func (m *IssueSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateIssueSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]IssueSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(IssueSearchResultItem_text_matchesable)
            }
...
func (m *IssueSearchResultItem) GetId()(*int32) {
    return m.id
}
...
func (m *IssueSearchResultItem) GetScore()(*int64) {
    return m.score
}
...
func (m *IssueSearchResultItem) GetTextMatches()([]IssueSearchResultItem_text_matchesable) {
...
func (m *IssueSearchResultItem) SetId(value *int32)() {
    m.id = value
}
...
func (m *IssueSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
...
func (m *IssueSearchResultItem) SetTextMatches(value []IssueSearchResultItem_text_matchesable)() {
