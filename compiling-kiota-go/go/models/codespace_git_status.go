...
// Codespace_git_status details about the codespace's git repository.
type Codespace_git_status struct {
...
func (m *Codespace_git_status) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *Codespace_git_status) SetHasUncommittedChanges(value *bool)() {
...
func (m *Codespace_git_status) SetHasUnpushedChanges(value *bool)() {
