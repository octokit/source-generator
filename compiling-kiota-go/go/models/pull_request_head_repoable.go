...
// PullRequest_head_repoable 
type PullRequest_head_repoable interface {
    ...
    GetLicense()(PullRequest_head_repo_licenseable)
    ...
    GetOwner()(PullRequest_head_repo_ownerable)
    GetPermissions()(PullRequest_head_repo_permissionsable)
    GetPrivate()(*bool)
    GetPullsUrl()(*string)
    ...
    SetLicense(value PullRequest_head_repo_licenseable)()
    ...
    SetOwner(value PullRequest_head_repo_ownerable)()
