...
type TopicSearchResultItem struct {
    ...
    text_matches []TopicSearchResultItem_text_matchesable
...
func (m *TopicSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateTopicSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]TopicSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(TopicSearchResultItem_text_matchesable)
            }
...
func (m *TopicSearchResultItem) GetScore()(*int64) {
    return m.score
}
...
func (m *TopicSearchResultItem) GetTextMatches()([]TopicSearchResultItem_text_matchesable) {
...
func (m *TopicSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
...
func (m *TopicSearchResultItem) SetTextMatches(value []TopicSearchResultItem_text_matchesable)() {
