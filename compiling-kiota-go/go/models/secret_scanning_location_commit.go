...
func (m *SecretScanningLocationCommit) GetEndColumn()(*int64) {
    return m.end_column
}
// GetEndLine gets the end_line property value. Line number at which the secret ends in the file
func (m *SecretScanningLocationCommit) GetEndLine()(*int64) {
    return m.end_line
}
...
func (m *SecretScanningLocationCommit) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    ...
    {
        err := writer.WriteInt64Value("end_column", m.GetEndColumn())
        if err != nil {
            return err
        }
    }
    {
        err := writer.WriteInt64Value("end_line", m.GetEndLine())
        if err != nil {
            return err
        }
    }
    ...
    {
        err := writer.WriteInt64Value("start_column", m.GetStartColumn())
        if err != nil {
            return err
        }
    }
    {
        err := writer.WriteInt64Value("start_line", m.GetStartLine())
        if err != nil {
            return err
        }
    }
...
func (m *SecretScanningLocationCommit) SetEndColumn(value *int64)() {
    m.end_column = value
}
// SetEndLine sets the end_line property value. Line number at which the secret ends in the file
func (m *SecretScanningLocationCommit) SetEndLine(value *int64)() {
    m.end_line = value
}
...
func (m *SecretScanningLocationCommit) SetStartColumn(value *int64)() {
    m.start_column = value
}
// SetStartLine sets the start_line property value. Line number at which the secret starts in the file
func (m *SecretScanningLocationCommit) SetStartLine(value *int64)() {
    m.start_line = value
}
