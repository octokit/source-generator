...
func (m *WorkflowRunUsage_billable_UBUNTU_job_runs) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *WorkflowRunUsage_billable_UBUNTU_job_runs) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetDurationMs sets the duration_ms property value. The duration_ms property
func (m *WorkflowRunUsage_billable_UBUNTU_job_runs) SetDurationMs(value *int32)() {
    m.duration_ms = value
}
