...
func (m *GitTag_tagger) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GitTag_tagger) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetDate sets the date property value. The date property
func (m *GitTag_tagger) SetDate(value *string)() {
    m.date = value
}
// SetEmail sets the email property value. The email property
func (m *GitTag_tagger) SetEmail(value *string)() {
    m.email = value
}
