...
// Repository_template_repositoryable 
type Repository_template_repositoryable interface {
    ...
    GetMergeCommitMessage()(*Repository_template_repository_merge_commit_message)
    GetMergeCommitTitle()(*Repository_template_repository_merge_commit_title)
    GetMergesUrl()(*string)
    ...
    GetOwner()(Repository_template_repository_ownerable)
    GetPermissions()(Repository_template_repository_permissionsable)
    GetPrivate()(*bool)
    GetPullsUrl()(*string)
    GetPushedAt()(*string)
    GetReleasesUrl()(*string)
    GetSize()(*int32)
    GetSquashMergeCommitMessage()(*Repository_template_repository_squash_merge_commit_message)
    GetSquashMergeCommitTitle()(*Repository_template_repository_squash_merge_commit_title)
    GetSshUrl()(*string)
    ...
    SetMergeCommitMessage(value *Repository_template_repository_merge_commit_message)()
    SetMergeCommitTitle(value *Repository_template_repository_merge_commit_title)()
    ...
    SetOwner(value Repository_template_repository_ownerable)()
    SetPermissions(value Repository_template_repository_permissionsable)()
    SetPrivate(value *bool)()
    SetPullsUrl(value *string)()
    SetPushedAt(value *string)()
    SetReleasesUrl(value *string)()
    SetSize(value *int32)()
    SetSquashMergeCommitMessage(value *Repository_template_repository_squash_merge_commit_message)()
    SetSquashMergeCommitTitle(value *Repository_template_repository_squash_merge_commit_title)()
