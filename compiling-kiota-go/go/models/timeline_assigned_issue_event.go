...
// NewTimelineAssignedIssueEvent instantiates a new TimelineAssignedIssueEvent and sets the default values.
func NewTimelineAssignedIssueEvent()(*TimelineAssignedIssueEvent) {
    m := &TimelineAssignedIssueEvent{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateTimelineAssignedIssueEventFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateTimelineAssignedIssueEventFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewTimelineAssignedIssueEvent(), nil
}
// GetActor gets the actor property value. A GitHub user.
func (m *TimelineAssignedIssueEvent) GetActor()(SimpleUserable) {
    return m.actor
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *TimelineAssignedIssueEvent) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAssignee gets the assignee property value. A GitHub user.
func (m *TimelineAssignedIssueEvent) GetAssignee()(SimpleUserable) {
    return m.assignee
}
// GetCommitId gets the commit_id property value. The commit_id property
func (m *TimelineAssignedIssueEvent) GetCommitId()(*string) {
    return m.commit_id
}
// GetCommitUrl gets the commit_url property value. The commit_url property
func (m *TimelineAssignedIssueEvent) GetCommitUrl()(*string) {
    return m.commit_url
}
// GetCreatedAt gets the created_at property value. The created_at property
func (m *TimelineAssignedIssueEvent) GetCreatedAt()(*string) {
    return m.created_at
}
// GetEvent gets the event property value. The event property
func (m *TimelineAssignedIssueEvent) GetEvent()(*string) {
    return m.event
}
// GetFieldDeserializers the deserialization information for the current model
func (m *TimelineAssignedIssueEvent) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *TimelineAssignedIssueEvent) GetId()(*int32) {
    return m.id
}
// GetNodeId gets the node_id property value. The node_id property
func (m *TimelineAssignedIssueEvent) GetNodeId()(*string) {
    return m.node_id
}
...
func (m *TimelineAssignedIssueEvent) GetPerformedViaGithubApp()(NullableIntegrationable) {
    return m.performed_via_github_app
}
// GetUrl gets the url property value. The url property
func (m *TimelineAssignedIssueEvent) GetUrl()(*string) {
    return m.url
}
// Serialize serializes information the current object
func (m *TimelineAssignedIssueEvent) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *TimelineAssignedIssueEvent) SetActor(value SimpleUserable)() {
    m.actor = value
}
// SetAdditionalData sets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *TimelineAssignedIssueEvent) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAssignee sets the assignee property value. A GitHub user.
func (m *TimelineAssignedIssueEvent) SetAssignee(value SimpleUserable)() {
    m.assignee = value
}
// SetCommitId sets the commit_id property value. The commit_id property
func (m *TimelineAssignedIssueEvent) SetCommitId(value *string)() {
    m.commit_id = value
}
// SetCommitUrl sets the commit_url property value. The commit_url property
func (m *TimelineAssignedIssueEvent) SetCommitUrl(value *string)() {
    m.commit_url = value
}
// SetCreatedAt sets the created_at property value. The created_at property
func (m *TimelineAssignedIssueEvent) SetCreatedAt(value *string)() {
    m.created_at = value
}
// SetEvent sets the event property value. The event property
func (m *TimelineAssignedIssueEvent) SetEvent(value *string)() {
    m.event = value
}
// SetId sets the id property value. The id property
func (m *TimelineAssignedIssueEvent) SetId(value *int32)() {
    m.id = value
}
// SetNodeId sets the node_id property value. The node_id property
func (m *TimelineAssignedIssueEvent) SetNodeId(value *string)() {
    m.node_id = value
}
...
func (m *TimelineAssignedIssueEvent) SetPerformedViaGithubApp(value NullableIntegrationable)() {
    m.performed_via_github_app = value
}
// SetUrl sets the url property value. The url property
func (m *TimelineAssignedIssueEvent) SetUrl(value *string)() {
    m.url = value
}
