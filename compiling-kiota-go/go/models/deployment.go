...
type Deployment struct {
    ...
    payload Deployment_Pending_deploymentsable
...
// Deployment_Pending_deployments composed type wrapper for classes pending_deploymentsMember1, string
type Deployment_Pending_deployments struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // Composed type representation for type pending_deploymentsMember1
    pending_deploymentsMember1 Pending_deploymentsMember1able
    // Serialization hint for the current wrapper.
    SerializationHint *string
    // Composed type representation for type string
    string *string
}
// NewDeployment_Pending_deployments instantiates a new pending_deployments and sets the default values.
func NewDeployment_Pending_deployments()(*Deployment_Pending_deployments) {
    m := &Deployment_Pending_deployments{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateDeployment_Pending_deploymentsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateDeployment_Pending_deploymentsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewDeployment_Pending_deployments()
    if parseNode != nil {
...
func (m *Deployment_Pending_deployments) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *Deployment_Pending_deployments) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetPendingDeploymentsMember1 gets the pending_deploymentsMember1 property value. Composed type representation for type pending_deploymentsMember1
func (m *Deployment_Pending_deployments) GetPendingDeploymentsMember1()(Pending_deploymentsMember1able) {
    return m.pending_deploymentsMember1
}
// GetString gets the string property value. Composed type representation for type string
func (m *Deployment_Pending_deployments) GetString()(*string) {
    return m.string
}
// Serialize serializes information the current object
func (m *Deployment_Pending_deployments) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetPendingDeploymentsMember1() != nil {
        err := writer.WriteObjectValue("", m.GetPendingDeploymentsMember1())
        if err != nil {
            return err
        }
...
func (m *Deployment_Pending_deployments) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetPendingDeploymentsMember1 sets the pending_deploymentsMember1 property value. Composed type representation for type pending_deploymentsMember1
func (m *Deployment_Pending_deployments) SetPendingDeploymentsMember1(value Pending_deploymentsMember1able)() {
    m.pending_deploymentsMember1 = value
}
// SetString sets the string property value. Composed type representation for type string
func (m *Deployment_Pending_deployments) SetString(value *string)() {
    m.string = value
}
// Deployment_Pending_deploymentsable 
type Deployment_Pending_deploymentsable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetPendingDeploymentsMember1()(Pending_deploymentsMember1able)
    GetString()(*string)
    SetPendingDeploymentsMember1(value Pending_deploymentsMember1able)()
...
func (m *Deployment) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["payload"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateDeployment_Pending_deploymentsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPayload(val.(Deployment_Pending_deploymentsable))
        }
        return nil
    }
...
func (m *Deployment) GetPayload()(Deployment_Pending_deploymentsable) {
    return m.payload
}
...
func (m *Deployment) SetPayload(value Deployment_Pending_deploymentsable)() {
    m.payload = value
}
