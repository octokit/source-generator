...
func (m *NullableMinimalRepository_permissions) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *NullableMinimalRepository_permissions) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAdmin sets the admin property value. The admin property
func (m *NullableMinimalRepository_permissions) SetAdmin(value *bool)() {
    m.admin = value
}
// SetMaintain sets the maintain property value. The maintain property
func (m *NullableMinimalRepository_permissions) SetMaintain(value *bool)() {
    m.maintain = value
}
// SetPull sets the pull property value. The pull property
func (m *NullableMinimalRepository_permissions) SetPull(value *bool)() {
    m.pull = value
}
// SetPush sets the push property value. The push property
func (m *NullableMinimalRepository_permissions) SetPush(value *bool)() {
    m.push = value
}
