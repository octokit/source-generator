...
type CodeSearchResultItem struct {
    ...
    text_matches []CodeSearchResultItem_text_matchesable
    // The url property
    url *string
}
...
func (m *CodeSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateCodeSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]CodeSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(CodeSearchResultItem_text_matchesable)
            }
...
func (m *CodeSearchResultItem) GetScore()(*int64) {
    return m.score
}
...
func (m *CodeSearchResultItem) GetTextMatches()([]CodeSearchResultItem_text_matchesable) {
...
func (m *CodeSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
...
func (m *CodeSearchResultItem) SetTextMatches(value []CodeSearchResultItem_text_matchesable)() {
