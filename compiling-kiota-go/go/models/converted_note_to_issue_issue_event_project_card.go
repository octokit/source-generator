...
func (m *ConvertedNoteToIssueIssueEvent_project_card) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ConvertedNoteToIssueIssueEvent_project_card) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetColumnName sets the column_name property value. The column_name property
func (m *ConvertedNoteToIssueIssueEvent_project_card) SetColumnName(value *string)() {
    m.column_name = value
}
// SetId sets the id property value. The id property
func (m *ConvertedNoteToIssueIssueEvent_project_card) SetId(value *int32)() {
    m.id = value
}
// SetPreviousColumnName sets the previous_column_name property value. The previous_column_name property
func (m *ConvertedNoteToIssueIssueEvent_project_card) SetPreviousColumnName(value *string)() {
    m.previous_column_name = value
}
// SetProjectId sets the project_id property value. The project_id property
func (m *ConvertedNoteToIssueIssueEvent_project_card) SetProjectId(value *int32)() {
    m.project_id = value
}
// SetProjectUrl sets the project_url property value. The project_url property
func (m *ConvertedNoteToIssueIssueEvent_project_card) SetProjectUrl(value *string)() {
    m.project_url = value
}
