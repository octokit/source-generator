...
type NullableIssue struct {
    ...
    pull_request NullableIssue_pull_requestable
...
func (m *NullableIssue) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["pull_request"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateNullableIssue_pull_requestFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPullRequest(val.(NullableIssue_pull_requestable))
        }
        return nil
    }
    ...
    res["state_reason"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseNullableIssue_state_reason)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStateReason(val.(*NullableIssue_state_reason))
        }
        return nil
    }
...
func (m *NullableIssue) GetId()(*int32) {
    return m.id
}
...
func (m *NullableIssue) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *NullableIssue) SetPerformedViaGithubApp(value NullableIntegrationable)() {
...
func (m *NullableIssue) SetTitle(value *string)() {
    m.title = value
}
// SetUpdatedAt sets the updated_at property value. The updated_at property
func (m *NullableIssue) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updated_at = value
}
// SetUrl sets the url property value. URL for the issue
func (m *NullableIssue) SetUrl(value *string)() {
    m.url = value
}
