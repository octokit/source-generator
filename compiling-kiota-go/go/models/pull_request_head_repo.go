...
type PullRequest_head_repo struct {
    ...
    license PullRequest_head_repo_licenseable
    ...
    // The owner property
    owner PullRequest_head_repo_ownerable
    // The permissions property
    permissions PullRequest_head_repo_permissionsable
...
// NewPullRequest_head_repo instantiates a new PullRequest_head_repo and sets the default values.
func NewPullRequest_head_repo()(*PullRequest_head_repo) {
    m := &PullRequest_head_repo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePullRequest_head_repoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreatePullRequest_head_repoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPullRequest_head_repo(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *PullRequest_head_repo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAllowForking gets the allow_forking property value. The allow_forking property
func (m *PullRequest_head_repo) GetAllowForking()(*bool) {
    return m.allow_forking
}
// GetAllowMergeCommit gets the allow_merge_commit property value. The allow_merge_commit property
func (m *PullRequest_head_repo) GetAllowMergeCommit()(*bool) {
...
func (m *PullRequest_head_repo) GetAllowRebaseMerge()(*bool) {
...
func (m *PullRequest_head_repo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["license"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreatePullRequest_head_repo_licenseFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetLicense(val.(PullRequest_head_repo_licenseable))
        }
        return nil
    }
    ...
    res["owner"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreatePullRequest_head_repo_ownerFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetOwner(val.(PullRequest_head_repo_ownerable))
        }
        return nil
    }
    res["permissions"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreatePullRequest_head_repo_permissionsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPermissions(val.(PullRequest_head_repo_permissionsable))
        }
        return nil
    }
...
func (m *PullRequest_head_repo) GetWebCommitSignoffRequired()(*bool) {
    return m.web_commit_signoff_required
}
// Serialize serializes information the current object
func (m *PullRequest_head_repo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PullRequest_head_repo) SetWebCommitSignoffRequired(value *bool)() {
