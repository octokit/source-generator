...
type MovedColumnInProjectIssueEvent struct {
    ...
    project_card MovedColumnInProjectIssueEvent_project_cardable
    // The url property
    url *string
}
...
func (m *MovedColumnInProjectIssueEvent) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["project_card"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateMovedColumnInProjectIssueEvent_project_cardFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetProjectCard(val.(MovedColumnInProjectIssueEvent_project_cardable))
        }
        return nil
    }
...
func (m *MovedColumnInProjectIssueEvent) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *MovedColumnInProjectIssueEvent) SetActor(value SimpleUserable)() {
    m.actor = value
}
// SetAdditionalData sets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *MovedColumnInProjectIssueEvent) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCommitId sets the commit_id property value. The commit_id property
func (m *MovedColumnInProjectIssueEvent) SetCommitId(value *string)() {
    m.commit_id = value
}
// SetCommitUrl sets the commit_url property value. The commit_url property
func (m *MovedColumnInProjectIssueEvent) SetCommitUrl(value *string)() {
    m.commit_url = value
}
// SetCreatedAt sets the created_at property value. The created_at property
func (m *MovedColumnInProjectIssueEvent) SetCreatedAt(value *string)() {
    m.created_at = value
}
// SetEvent sets the event property value. The event property
func (m *MovedColumnInProjectIssueEvent) SetEvent(value *string)() {
    m.event = value
}
// SetId sets the id property value. The id property
func (m *MovedColumnInProjectIssueEvent) SetId(value *int32)() {
    m.id = value
}
// SetNodeId sets the node_id property value. The node_id property
func (m *MovedColumnInProjectIssueEvent) SetNodeId(value *string)() {
    m.node_id = value
}
...
func (m *MovedColumnInProjectIssueEvent) SetPerformedViaGithubApp(value NullableIntegrationable)() {
    m.performed_via_github_app = value
}
// SetProjectCard sets the project_card property value. The project_card property
func (m *MovedColumnInProjectIssueEvent) SetProjectCard(value MovedColumnInProjectIssueEvent_project_cardable)() {
