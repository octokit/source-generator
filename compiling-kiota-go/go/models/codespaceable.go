...
type Codespaceable interface {
    ...
    GetLocation()(*Codespace_location)
    ...
    GetRuntimeConstraints()(Codespace_runtime_constraintsable)
    GetStartUrl()(*string)
    GetState()(*Codespace_state)
    GetStopUrl()(*string)
    ...
    SetLocation(value *Codespace_location)()
    ...
    SetRuntimeConstraints(value Codespace_runtime_constraintsable)()
    SetStartUrl(value *string)()
    SetState(value *Codespace_state)()
