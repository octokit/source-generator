...
// DemilestonedIssueEventable 
type DemilestonedIssueEventable interface {
    ...
    GetEvent()(*string)
    GetId()(*int32)
    GetMilestone()(DemilestonedIssueEvent_milestoneable)
    GetNodeId()(*string)
    ...
    SetId(value *int32)()
    SetMilestone(value DemilestonedIssueEvent_milestoneable)()
