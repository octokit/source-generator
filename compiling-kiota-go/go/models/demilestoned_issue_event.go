...
type DemilestonedIssueEvent struct {
    ...
    milestone DemilestonedIssueEvent_milestoneable
...
// NewDemilestonedIssueEvent instantiates a new DemilestonedIssueEvent and sets the default values.
func NewDemilestonedIssueEvent()(*DemilestonedIssueEvent) {
    m := &DemilestonedIssueEvent{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateDemilestonedIssueEventFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateDemilestonedIssueEventFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewDemilestonedIssueEvent(), nil
}
// GetActor gets the actor property value. A GitHub user.
func (m *DemilestonedIssueEvent) GetActor()(SimpleUserable) {
    return m.actor
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DemilestonedIssueEvent) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCommitId gets the commit_id property value. The commit_id property
func (m *DemilestonedIssueEvent) GetCommitId()(*string) {
    return m.commit_id
}
// GetCommitUrl gets the commit_url property value. The commit_url property
func (m *DemilestonedIssueEvent) GetCommitUrl()(*string) {
    return m.commit_url
}
// GetCreatedAt gets the created_at property value. The created_at property
func (m *DemilestonedIssueEvent) GetCreatedAt()(*string) {
    return m.created_at
}
// GetEvent gets the event property value. The event property
func (m *DemilestonedIssueEvent) GetEvent()(*string) {
    return m.event
}
// GetFieldDeserializers the deserialization information for the current model
func (m *DemilestonedIssueEvent) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["milestone"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateDemilestonedIssueEvent_milestoneFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMilestone(val.(DemilestonedIssueEvent_milestoneable))
        }
        return nil
    }
...
func (m *DemilestonedIssueEvent) GetId()(*int32) {
    return m.id
}
// GetMilestone gets the milestone property value. The milestone property
func (m *DemilestonedIssueEvent) GetMilestone()(DemilestonedIssueEvent_milestoneable) {
    return m.milestone
}
// GetNodeId gets the node_id property value. The node_id property
func (m *DemilestonedIssueEvent) GetNodeId()(*string) {
    return m.node_id
}
...
func (m *DemilestonedIssueEvent) GetPerformedViaGithubApp()(NullableIntegrationable) {
    return m.performed_via_github_app
}
// GetUrl gets the url property value. The url property
func (m *DemilestonedIssueEvent) GetUrl()(*string) {
    return m.url
}
// Serialize serializes information the current object
func (m *DemilestonedIssueEvent) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *DemilestonedIssueEvent) SetActor(value SimpleUserable)() {
    m.actor = value
}
// SetAdditionalData sets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *DemilestonedIssueEvent) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCommitId sets the commit_id property value. The commit_id property
func (m *DemilestonedIssueEvent) SetCommitId(value *string)() {
    m.commit_id = value
}
// SetCommitUrl sets the commit_url property value. The commit_url property
func (m *DemilestonedIssueEvent) SetCommitUrl(value *string)() {
    m.commit_url = value
}
// SetCreatedAt sets the created_at property value. The created_at property
func (m *DemilestonedIssueEvent) SetCreatedAt(value *string)() {
    m.created_at = value
}
// SetEvent sets the event property value. The event property
func (m *DemilestonedIssueEvent) SetEvent(value *string)() {
    m.event = value
}
// SetId sets the id property value. The id property
func (m *DemilestonedIssueEvent) SetId(value *int32)() {
    m.id = value
}
// SetMilestone sets the milestone property value. The milestone property
func (m *DemilestonedIssueEvent) SetMilestone(value DemilestonedIssueEvent_milestoneable)() {
    m.milestone = value
}
// SetNodeId sets the node_id property value. The node_id property
func (m *DemilestonedIssueEvent) SetNodeId(value *string)() {
    m.node_id = value
}
...
func (m *DemilestonedIssueEvent) SetPerformedViaGithubApp(value NullableIntegrationable)() {
    m.performed_via_github_app = value
}
// SetUrl sets the url property value. The url property
func (m *DemilestonedIssueEvent) SetUrl(value *string)() {
    m.url = value
}
