...
type NullableRepository struct {
    ...
    template_repository NullableRepository_template_repositoryable
    // The topics property
    topics []string
...
func (m *NullableRepository) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["template_repository"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateNullableRepository_template_repositoryFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTemplateRepository(val.(NullableRepository_template_repositoryable))
        }
        return nil
    }
...
func (m *NullableRepository) GetNetworkCount()(*int32) {
...
func (m *NullableRepository) GetOrganization()(NullableSimpleUserable) {
...
func (m *NullableRepository) GetSubscribersCount()(*int32) {
...
func (m *NullableRepository) GetTemplateRepository()(NullableRepository_template_repositoryable) {
...
func (m *NullableRepository) SetNetworkCount(value *int32)() {
...
func (m *NullableRepository) SetOrganization(value NullableSimpleUserable)() {
...
func (m *NullableRepository) SetSubscribersCount(value *int32)() {
...
func (m *NullableRepository) SetTemplateRepository(value NullableRepository_template_repositoryable)() {
