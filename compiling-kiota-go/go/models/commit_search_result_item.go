...
type CommitSearchResultItem struct {
    ...
    text_matches []CommitSearchResultItem_text_matchesable
    // The url property
    url *string
}
...
func (m *CommitSearchResultItem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["text_matches"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateCommitSearchResultItem_text_matchesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]CommitSearchResultItem_text_matchesable, len(val))
            for i, v := range val {
                res[i] = v.(CommitSearchResultItem_text_matchesable)
            }
...
func (m *CommitSearchResultItem) GetScore()(*int64) {
    return m.score
}
...
func (m *CommitSearchResultItem) GetTextMatches()([]CommitSearchResultItem_text_matchesable) {
...
func (m *CommitSearchResultItem) SetScore(value *int64)() {
    m.score = value
}
...
func (m *CommitSearchResultItem) SetTextMatches(value []CommitSearchResultItem_text_matchesable)() {
