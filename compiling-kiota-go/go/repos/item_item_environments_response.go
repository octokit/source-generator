...
type ItemItemEnvironmentsResponse struct {
    ...
    environments []ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Environmentable
...
func (m *ItemItemEnvironmentsResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetEnvironments gets the environments property value. The environments property
func (m *ItemItemEnvironmentsResponse) GetEnvironments()([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Environmentable) {
    return m.environments
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemItemEnvironmentsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["environments"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreateEnvironmentFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Environmentable, len(val))
            for i, v := range val {
                res[i] = v.(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Environmentable)
            }
...
func (m *ItemItemEnvironmentsResponse) GetTotalCount()(*int32) {
    return m.total_count
}
// Serialize serializes information the current object
func (m *ItemItemEnvironmentsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *ItemItemEnvironmentsResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetEnvironments sets the environments property value. The environments property
func (m *ItemItemEnvironmentsResponse) SetEnvironments(value []ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Environmentable)() {
    m.environments = value
}
// SetTotalCount sets the total_count property value. The number of environments in this repository
func (m *ItemItemEnvironmentsResponse) SetTotalCount(value *int32)() {
    m.total_count = value
}
