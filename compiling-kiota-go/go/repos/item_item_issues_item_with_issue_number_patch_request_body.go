...
// ItemItemIssuesItemWithIssue_numberPatchRequestBody 
type ItemItemIssuesItemWithIssue_numberPatchRequestBody struct {
    ...
    milestone ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable
    // The title of the issue.
    title ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable
}
// ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number composed type wrapper for classes string, integer
type ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
...
// NewItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number instantiates a new WithIssue_number and sets the default values.
func NewItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number()(*ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) {
    m := &ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    result := NewItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number()
    if parseNode != nil {
...
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    return make(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error))
}
// GetInteger gets the integer property value. Composed type representation for type integer
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) GetInteger()(*int32) {
    return m.integer
}
// GetString gets the string property value. Composed type representation for type string
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) GetString()(*string) {
    return m.string
}
// Serialize serializes information the current object
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetInteger() != nil {
...
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetInteger sets the integer property value. Composed type representation for type integer
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) SetInteger(value *int32)() {
    m.integer = value
}
// SetString sets the string property value. Composed type representation for type string
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_number) SetString(value *string)() {
    m.string = value
}
// ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable 
type ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable interface {
...
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["milestone"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMilestone(val.(ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable))
        }
        return nil
    }
    res["title"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetTitle(val.(ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable))
        }
        return nil
    }
    return res
...
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody) GetMilestone()(ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable) {
    return m.milestone
}
// GetTitle gets the title property value. The title of the issue.
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody) GetTitle()(ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable) {
    return m.title
}
// Serialize serializes information the current object
...
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody) SetMilestone(value ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable)() {
    m.milestone = value
}
// SetTitle sets the title property value. The title of the issue.
func (m *ItemItemIssuesItemWithIssue_numberPatchRequestBody) SetTitle(value ItemItemIssuesItemWithIssue_numberPatchRequestBody_WithIssue_numberable)() {
    m.title = value
}
