...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Codespaces()(*ItemItemPullsItemCodespacesRequestBuilder) {
    return NewItemItemPullsItemCodespacesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Comments()(*ItemItemPullsItemCommentsRequestBuilder) {
    return NewItemItemPullsItemCommentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// CommentsById gets an item from the github.com/octokit/kiota/.repos.item.item.pulls.item.comments.item collection
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) CommentsById(id string)(*ItemItemPullsItemCommentsWithComment_ItemRequestBuilder) {
    ...
    return NewItemItemPullsItemCommentsWithComment_ItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Commits()(*ItemItemPullsItemCommitsRequestBuilder) {
    return NewItemItemPullsItemCommitsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func NewItemItemPullsWithPull_numberItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemPullsWithPull_numberItemRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/pulls/{pull_number}";
    urlTplParams := make(map[string]string)
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Files()(*ItemItemPullsItemFilesRequestBuilder) {
    return NewItemItemPullsItemFilesRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemPullsWithPull_numberItemRequestBuilderGetRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.PullRequestable, error) {
    ...
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        ...
        "503": ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreatePullRequest503ErrorFromDiscriminatorValue,
    }
    res, err := m.requestAdapter.Send(ctx, requestInfo, ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreatePullRequestFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.PullRequestable), nil
}
// Merge the merge property
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Merge()(*ItemItemPullsItemMergeRequestBuilder) {
    return NewItemItemPullsItemMergeRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Patch(ctx context.Context, body ItemItemPullsItemWithPull_numberPatchRequestBodyable, requestConfiguration *ItemItemPullsWithPull_numberItemRequestBuilderPatchRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.PullRequestable, error) {
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Requested_reviewers()(*ItemItemPullsItemRequested_reviewersRequestBuilder) {
    return NewItemItemPullsItemRequested_reviewersRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) Reviews()(*ItemItemPullsItemReviewsRequestBuilder) {
    return NewItemItemPullsItemReviewsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// ReviewsById gets an item from the github.com/octokit/kiota/.repos.item.item.pulls.item.reviews.item collection
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) ReviewsById(id string)(*ItemItemPullsItemReviewsWithReview_ItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    if id != "" {
        urlTplParams["review_id"] = id
    }
    return NewItemItemPullsItemReviewsWithReview_ItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func (m *ItemItemPullsWithPull_numberItemRequestBuilder) UpdateBranch()(*ItemItemPullsItemUpdateBranchRequestBuilder) {
    return NewItemItemPullsItemUpdateBranchRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
