...
func (m *ItemItemNotificationsResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemItemNotificationsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemNotificationsResponse) GetMessage()(*string) {
    return m.message
}
// GetUrl gets the url property value. The url property
func (m *ItemItemNotificationsResponse) GetUrl()(*string) {
    return m.url
}
// Serialize serializes information the current object
func (m *ItemItemNotificationsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemNotificationsResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetMessage sets the message property value. The message property
func (m *ItemItemNotificationsResponse) SetMessage(value *string)() {
    m.message = value
}
// SetUrl sets the url property value. The url property
func (m *ItemItemNotificationsResponse) SetUrl(value *string)() {
    m.url = value
}
