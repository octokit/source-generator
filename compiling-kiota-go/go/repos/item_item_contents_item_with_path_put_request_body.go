...
// ItemItemContentsItemWithPathPutRequestBody 
...
// GetBranch gets the branch property value. The branch name. Default: the repository’s default branch (usually `master`)
...
// SetBranch sets the branch property value. The branch name. Default: the repository’s default branch (usually `master`)
