...
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) GetJobs()([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Jobable) {
    return m.jobs
}
// GetTotalCount gets the total_count property value. The total_count property
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) GetTotalCount()(*int32) {
    return m.total_count
}
// Serialize serializes information the current object
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetJobs() != nil {
...
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetJobs sets the jobs property value. The jobs property
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) SetJobs(value []ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Jobable)() {
    m.jobs = value
}
// SetTotalCount sets the total_count property value. The total_count property
func (m *ItemItemActionsRunsItemAttemptsItemJobsResponse) SetTotalCount(value *int32)() {
    m.total_count = value
}
