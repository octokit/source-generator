...
func (m *ItemItemPullsRequestBuilder) Comments()(*ItemItemPullsCommentsRequestBuilder) {
    return NewItemItemPullsCommentsRequestBuilderInternal(m.pathParameters, m.requestAdapter)
}
// CommentsById gets an item from the github.com/octokit/kiota/.repos.item.item.pulls.comments.item collection
func (m *ItemItemPullsRequestBuilder) CommentsById(id string)(*ItemItemPullsCommentsWithComment_ItemRequestBuilder) {
    ...
    return NewItemItemPullsCommentsWithComment_ItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func NewItemItemPullsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemPullsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/pulls{?state*,head*,base*,sort*,direction*,per_page*,page*}";
    urlTplParams := make(map[string]string)
...
func (m *ItemItemPullsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemPullsRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.PullRequestSimpleable, error) {
    ...
    res, err := m.requestAdapter.SendCollection(ctx, requestInfo, ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreatePullRequestSimpleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
...
func (m *ItemItemPullsRequestBuilder) Post(ctx context.Context, body ItemItemPullsPostRequestBodyable, requestConfiguration *ItemItemPullsRequestBuilderPostRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.PullRequestable, error) {
