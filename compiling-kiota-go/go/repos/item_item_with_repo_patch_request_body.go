...
// ItemItemWithRepoPatchRequestBody 
type ItemItemWithRepoPatchRequestBody struct {
...
// NewItemItemWithRepoPatchRequestBody instantiates a new ItemItemWithRepoPatchRequestBody and sets the default values.
func NewItemItemWithRepoPatchRequestBody()(*ItemItemWithRepoPatchRequestBody) {
    m := &ItemItemWithRepoPatchRequestBody{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemItemWithRepoPatchRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
func CreateItemItemWithRepoPatchRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemItemWithRepoPatchRequestBody(), nil
}
// GetAdditionalData gets the additionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ItemItemWithRepoPatchRequestBody) GetAdditionalData()(map[string]any) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetAllowAutoMerge()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetAllowForking()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetAllowMergeCommit()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetAllowRebaseMerge()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetAllowSquashMerge()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetAllowUpdateBranch()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetArchived()(*bool) {
    return m.archived
}
// GetDefaultBranch gets the default_branch property value. Updates the default branch for this repository.
func (m *ItemItemWithRepoPatchRequestBody) GetDefaultBranch()(*string) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetDeleteBranchOnMerge()(*bool) {
    return m.delete_branch_on_merge
}
// GetDescription gets the description property value. A short description of the repository.
func (m *ItemItemWithRepoPatchRequestBody) GetDescription()(*string) {
    return m.description
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemItemWithRepoPatchRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["security_and_analysis"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemItemWithRepoPatchRequestBody_security_and_analysisFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSecurityAndAnalysis(val.(ItemItemWithRepoPatchRequestBody_security_and_analysisable))
        }
        return nil
    }
...
func (m *ItemItemWithRepoPatchRequestBody) GetHasIssues()(*bool) {
    return m.has_issues
}
...
func (m *ItemItemWithRepoPatchRequestBody) GetHasProjects()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetHasWiki()(*bool) {
    return m.has_wiki
}
// GetHomepage gets the homepage property value. A URL with more information about the repository.
func (m *ItemItemWithRepoPatchRequestBody) GetHomepage()(*string) {
    return m.homepage
}
...
func (m *ItemItemWithRepoPatchRequestBody) GetIsTemplate()(*bool) {
    return m.is_template
}
// GetName gets the name property value. The name of the repository.
func (m *ItemItemWithRepoPatchRequestBody) GetName()(*string) {
    return m.name
}
...
func (m *ItemItemWithRepoPatchRequestBody) GetPrivate()(*bool) {
    return m.private
}
...
func (m *ItemItemWithRepoPatchRequestBody) GetUseSquashPrTitleAsDefault()(*bool) {
...
func (m *ItemItemWithRepoPatchRequestBody) GetWebCommitSignoffRequired()(*bool) {
    return m.web_commit_signoff_required
}
// Serialize serializes information the current object
func (m *ItemItemWithRepoPatchRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAdditionalData(value map[string]any)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAllowAutoMerge(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAllowForking(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAllowMergeCommit(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAllowRebaseMerge(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAllowSquashMerge(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetAllowUpdateBranch(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetArchived(value *bool)() {
    m.archived = value
}
// SetDefaultBranch sets the default_branch property value. Updates the default branch for this repository.
func (m *ItemItemWithRepoPatchRequestBody) SetDefaultBranch(value *string)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetDeleteBranchOnMerge(value *bool)() {
    m.delete_branch_on_merge = value
}
// SetDescription sets the description property value. A short description of the repository.
func (m *ItemItemWithRepoPatchRequestBody) SetDescription(value *string)() {
    m.description = value
}
...
func (m *ItemItemWithRepoPatchRequestBody) SetHasIssues(value *bool)() {
    m.has_issues = value
}
...
func (m *ItemItemWithRepoPatchRequestBody) SetHasProjects(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetHasWiki(value *bool)() {
    m.has_wiki = value
}
// SetHomepage sets the homepage property value. A URL with more information about the repository.
func (m *ItemItemWithRepoPatchRequestBody) SetHomepage(value *string)() {
    m.homepage = value
}
...
func (m *ItemItemWithRepoPatchRequestBody) SetIsTemplate(value *bool)() {
    m.is_template = value
}
// SetName sets the name property value. The name of the repository.
func (m *ItemItemWithRepoPatchRequestBody) SetName(value *string)() {
    m.name = value
}
...
func (m *ItemItemWithRepoPatchRequestBody) SetPrivate(value *bool)() {
    m.private = value
}
...
func (m *ItemItemWithRepoPatchRequestBody) SetSecurityAndAnalysis(value ItemItemWithRepoPatchRequestBody_security_and_analysisable)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetUseSquashPrTitleAsDefault(value *bool)() {
...
func (m *ItemItemWithRepoPatchRequestBody) SetWebCommitSignoffRequired(value *bool)() {
