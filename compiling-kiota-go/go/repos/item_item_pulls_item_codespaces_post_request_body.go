...
// ItemItemPullsItemCodespacesPostRequestBody 
...
// GetLocation gets the location property value. Location for this codespace. Assigned by IP if not provided
...
// SetLocation sets the location property value. Location for this codespace. Assigned by IP if not provided
