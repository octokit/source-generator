...
// ItemItemCommitsRequestBuilder builds and executes requests for operations under \repos\{owner}\{repo}\commits
...
type ItemItemCommitsRequestBuilderGetQueryParameters struct {
    ...
    Until *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time
}
...
// CommitsByCommit_sha gets an item from the github.com/octokit/kiota/.repos.item.item.commits.item collection
func (m *ItemItemCommitsRequestBuilder) CommitsByCommit_sha(id *string)(*ItemItemCommitsWithCommit_shaItemRequestBuilder) {
    ...
    return NewItemItemCommitsWithCommit_shaItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
// CommitsByRef gets an item from the github.com/octokit/kiota/.repos.item.item.commits.item collection
func (m *ItemItemCommitsRequestBuilder) CommitsByRef(id string)(*ItemItemCommitsWithRefItemRequestBuilder) {
    urlTplParams := make(map[string]string)
    for idx, item := range m.pathParameters {
        urlTplParams[idx] = item
    }
    ...
    return NewItemItemCommitsWithRefItemRequestBuilderInternal(urlTplParams, m.requestAdapter)
}
...
func NewItemItemCommitsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemCommitsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/commits{?sha*,path*,author*,since*,until*,per_page*,page*}";
    urlTplParams := make(map[string]string)
...
func (m *ItemItemCommitsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemCommitsRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Commitable, error) {
    ...
    res, err := m.requestAdapter.SendCollection(ctx, requestInfo, ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreateCommitFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
