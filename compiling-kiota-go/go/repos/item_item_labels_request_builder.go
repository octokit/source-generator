...
// ItemItemLabelsRequestBuilderGetQueryParameters list labels for a repository
...
func NewItemItemLabelsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemLabelsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/labels{?per_page*,page*}";
...
func (m *ItemItemLabelsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemLabelsRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Labelable, error) {
...
func (m *ItemItemLabelsRequestBuilder) Post(ctx context.Context, body ItemItemLabelsPostRequestBodyable, requestConfiguration *ItemItemLabelsRequestBuilderPostRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Labelable, error) {
