...
func (m *ItemItemActionsWorkflowsItemRunsResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
func (m *ItemItemActionsWorkflowsItemRunsResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *ItemItemActionsWorkflowsItemRunsResponse) GetTotalCount()(*int32) {
    return m.total_count
}
// GetWorkflowRuns gets the workflow_runs property value. The workflow_runs property
func (m *ItemItemActionsWorkflowsItemRunsResponse) GetWorkflowRuns()([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.WorkflowRunable) {
    return m.workflow_runs
}
// Serialize serializes information the current object
func (m *ItemItemActionsWorkflowsItemRunsResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *ItemItemActionsWorkflowsItemRunsResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetTotalCount sets the total_count property value. The total_count property
func (m *ItemItemActionsWorkflowsItemRunsResponse) SetTotalCount(value *int32)() {
    m.total_count = value
}
// SetWorkflowRuns sets the workflow_runs property value. The workflow_runs property
func (m *ItemItemActionsWorkflowsItemRunsResponse) SetWorkflowRuns(value []ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.WorkflowRunable)() {
