...
// ItemItemIssuesItemCommentsRequestBuilderGetQueryParameters issue Comments are ordered by ascending ID.
...
func NewItemItemIssuesItemCommentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemIssuesItemCommentsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/issues/{issue_number}/comments{?since*,per_page*,page*}";
...
// Get issue Comments are ordered by ascending ID.
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/rest/reference/issues#list-issue-comments
func (m *ItemItemIssuesItemCommentsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemIssuesItemCommentsRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.IssueCommentable, error) {
...
func (m *ItemItemIssuesItemCommentsRequestBuilder) Post(ctx context.Context, body ItemItemIssuesItemCommentsPostRequestBodyable, requestConfiguration *ItemItemIssuesItemCommentsRequestBuilderPostRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.IssueCommentable, error) {
...
// ToGetRequestInformation issue Comments are ordered by ascending ID.
