...
// ItemItemHooksItemWithHook_PatchRequestBody_config key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/rest/reference/repos#create-hook-config-params).
type ItemItemHooksItemWithHook_PatchRequestBody_config struct {
    ...
    insecure_ssl ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.WebhookConfigInsecureSslable
    // The room property
    room *string
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody_config) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["insecure_ssl"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.CreateWebhookConfigInsecureSslFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetInsecureSsl(val.(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.WebhookConfigInsecureSslable))
        }
        return nil
    }
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody_config) GetInsecureSsl()(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.WebhookConfigInsecureSslable) {
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody_config) SetInsecureSsl(value ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.WebhookConfigInsecureSslable)() {
