...
// ItemItemReleasesItemReactionsRequestBuilderGetQueryParameters list the reactions to a [release](https://docs.github.com/rest/reference/repos#releases).
...
func NewItemItemReleasesItemReactionsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemReleasesItemReactionsRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/releases/{release_id}/reactions{?content*,per_page*,page*}";
...
// Get list the reactions to a [release](https://docs.github.com/rest/reference/repos#releases).
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/rest/reference/reactions/#list-reactions-for-a-release
func (m *ItemItemReleasesItemReactionsRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemReleasesItemReactionsRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Reactionable, error) {
...
// Post create a reaction to a [release](https://docs.github.com/rest/reference/repos#releases). A response with a `Status: 200 OK` means that you already added the reaction type to this release.
// [API method documentation]
// 
...
// ToGetRequestInformation list the reactions to a [release](https://docs.github.com/rest/reference/repos#releases).
...
// ToPostRequestInformation create a reaction to a [release](https://docs.github.com/rest/reference/repos#releases). A response with a `Status: 200 OK` means that you already added the reaction type to this release.
