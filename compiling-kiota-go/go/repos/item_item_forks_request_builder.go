...
func NewItemItemForksRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemForksRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/repos/{owner}/{repo}/forks{?sort*,per_page*,page*}";
...
func (m *ItemItemForksRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemItemForksRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.MinimalRepositoryable, error) {
...
// Post create a fork for the authenticated user.**Note**: Forking a Repository happens asynchronously. You may have to wait a short period of time before you can access the git objects. If this takes longer than 5 minutes, be sure to contact [GitHub Support](https://support.github.com/contact?tags=dotcom-rest-api).
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/rest/reference/repos#create-a-fork
func (m *ItemItemForksRequestBuilder) Post(ctx context.Context, body ItemItemForksPostRequestBodyable, requestConfiguration *ItemItemForksRequestBuilderPostRequestConfiguration)(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.FullRepositoryable, error) {
