...
func (m *ItemTokenScopedPostRequestBody) GetPermissions()(ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.AppPermissionsable) {
    return m.permissions
}
// GetRepositories gets the repositories property value. The list of repository names to scope the user-to-server access token to. `repositories` may not be specified if `repository_ids` is specified.
func (m *ItemTokenScopedPostRequestBody) GetRepositories()([]string) {
    return m.repositories
}
// GetRepositoryIds gets the repository_ids property value. The list of repository IDs to scope the user-to-server access token to. `repository_ids` may not be specified if `repositories` is specified.
func (m *ItemTokenScopedPostRequestBody) GetRepositoryIds()([]int32) {
    return m.repository_ids
}
// GetTarget gets the target property value. The name of the user or organization to scope the user-to-server access token to. **Required** unless `target_id` is specified.
func (m *ItemTokenScopedPostRequestBody) GetTarget()(*string) {
    return m.target
}
// GetTargetId gets the target_id property value. The ID of the user or organization to scope the user-to-server access token to. **Required** unless `target` is specified.
...
func (m *ItemTokenScopedPostRequestBody) SetPermissions(value ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.AppPermissionsable)() {
    m.permissions = value
}
// SetRepositories sets the repositories property value. The list of repository names to scope the user-to-server access token to. `repositories` may not be specified if `repository_ids` is specified.
func (m *ItemTokenScopedPostRequestBody) SetRepositories(value []string)() {
    m.repositories = value
}
// SetRepositoryIds sets the repository_ids property value. The list of repository IDs to scope the user-to-server access token to. `repository_ids` may not be specified if `repositories` is specified.
func (m *ItemTokenScopedPostRequestBody) SetRepositoryIds(value []int32)() {
    m.repository_ids = value
}
// SetTarget sets the target property value. The name of the user or organization to scope the user-to-server access token to. **Required** unless `target_id` is specified.
func (m *ItemTokenScopedPostRequestBody) SetTarget(value *string)() {
    m.target = value
}
// SetTargetId sets the target_id property value. The ID of the user or organization to scope the user-to-server access token to. **Required** unless `target` is specified.
