...
// GetAccessToken gets the access_token property value. The access_token of the OAuth application.
...
// SetAccessToken sets the access_token property value. The access_token of the OAuth application.
