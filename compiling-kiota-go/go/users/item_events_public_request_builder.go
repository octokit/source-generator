...
func NewItemEventsPublicRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemEventsPublicRequestBuilder) {
    ...
    m.urlTemplate = "{+baseurl}/users/{username}/events/public{?per_page*,page*}";
...
func (m *ItemEventsPublicRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemEventsPublicRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.Eventable, error) {
