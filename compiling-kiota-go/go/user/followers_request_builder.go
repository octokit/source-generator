...
func NewFollowersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FollowersRequestBuilder) {
    m := &FollowersRequestBuilder{
    }
    m.urlTemplate = "{+baseurl}/user/followers{?per_page*,page*}";
...
func NewFollowersRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*FollowersRequestBuilder) {
    ...
    return NewFollowersRequestBuilderInternal(urlParams, requestAdapter)
}
// Get lists the people following the authenticated user.
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/rest/reference/users#list-followers-of-the-authenticated-user
func (m *FollowersRequestBuilder) Get(ctx context.Context, requestConfiguration *FollowersRequestBuilderGetRequestConfiguration)([]ib19f1474616f80bb588b8a50bea93468536b3ba5d3dffa1c19a10387bd034614.SimpleUserable, error) {
...
func (m *FollowersRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *FollowersRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
