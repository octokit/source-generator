...
1. Search the [project's issues](https://github.com/octokit/dotnet-sdk-enterprise-cloud/issues) to see if a similar issue already exists. If so, please add onto that issue rather than creating a new one.
